...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName ( UNIDADE_FABRIL, NOMFIL, DESCRICAO ) VALUES (@Coluna1, @Coluna2, @Coluna3)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_UNIDADE_FABRIL" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
