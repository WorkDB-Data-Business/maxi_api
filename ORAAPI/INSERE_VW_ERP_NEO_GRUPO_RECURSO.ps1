...
$url = "http://192.168.0.68:5500/grupo_recurso/_id/$parametroParaApi"
...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName (UNIDADE_FABRIL,  GRUPO ,  DESCRICAO, MAQUINA) VALUES (@Coluna1, @Coluna2, @Coluna3, @Coluna4)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_GRUPO_RECURSO" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
