...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName ( CODMOD, CODREG, NOMEATB, ATRIBUTO_TEXTO, ATRIBUTO_NUMERO , UNIMED,  ITEM ) VALUES (@Coluna1, @Coluna2, @Coluna3, @Coluna4,@Coluna5,@Coluna6,@Coluna7)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_ATRIBUTOS" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
