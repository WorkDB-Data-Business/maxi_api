...
$url = "http://192.168.0.68:5500/ordem_compra/_id/14"
...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName (UNIDADE_FABRIL, NUMOCP, ID_ITEM, DATENT, QTDREC, UNIMED ) VALUES (@Coluna1, @Coluna2, @Coluna3,@Coluna4, @Coluna5, @Coluna6)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_ORDEM_COMPRA" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
