...
$url = "http://192.168.0.68:5500/roteiro_fabricacao/_id/14"
...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName (UNIDADE_FABRIL, ID_ITEM, SEQROT, CODOPR, DESOPR, CODCRE, SEQ_AUTOMATICO,  UNICRE, TMPPRP, FERRAMENTA, TMPFIX, TIPO_ESPERA, TEMPO_MAXIMO ) VALUES (@Coluna1, @Coluna2, @Coluna3, @Coluna4,@Coluna5,@Coluna6,@Coluna7,@Coluna8,@Coluna9,13,@Coluna11,null,null)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_ROTEIRO_FABRICACAO" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
