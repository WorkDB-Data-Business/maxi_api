...
$url = "http://192.168.0.68:5500/lista_materiais/_id/$parametroParaApi"
...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName (UNIDADE_FABRIL, NUMORP, SEQROT, ITEM_REQUISITADO, QTDPRV, UNIDADE_PAI, UNIDADE_FILHO, ITEM_PAI, NUMPED) VALUES (@Coluna1, @Coluna2, @Coluna3, @Coluna4,@Coluna5,@Coluna6,@Coluna7,@Coluna8,@Coluna9)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_LISTA_MATERIAIS" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
