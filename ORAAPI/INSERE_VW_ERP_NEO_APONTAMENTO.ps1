...
$url = "http://192.168.0.68:5500/apontamentos/_id/$parametroParaApi"
...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName (UNIDADE_FABRIL, NUMORP, CODOPR, QTD_APONTADA, DATINI, DATREA, CODCRE, HORINI, HORREA) VALUES (@Coluna1, @Coluna2, @Coluna3,@Coluna4, @Coluna5, @Coluna6, @Coluna7, @Coluna8, @Coluna9)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_APONTAMENTO" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
