...
$url = "http://192.168.0.68:5500/manutencao/_id/$parametroParaApi"
...
function Insert-DataToSQL {
    ...
    $dado = @()
           ...
           foreach ($item in $data) {
                ...
                $command.CommandText = "INSERT INTO $tableName (UNIDADE_FABRIL, ORDEM_MANUTENCAO, RECURSO, TIPO_MANUTENCAO, FINAL_MANUTENCAO, DESMNT) VALUES (@Coluna1, @Coluna2, @Coluna3, @Coluna4,@Coluna5,@Coluna6)"  # Substitua pelas colunas necessárias
...
Insert-DataToSQL -connection $connection -tableName "TB_ERP_NEO_MANUTENCAO" -data $apiData  # Substitua "NomeDaTabela" pelo nome da sua tabela
